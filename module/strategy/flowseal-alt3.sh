...
config="--filter-tcp=80,443 --hostlist=$MODPATH/list/google.txt --hostlist-exclude=$MODPATH/list/exclude.txt --ip-id=zero --dpi-desync=fakedsplit --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --new"
